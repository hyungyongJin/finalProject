...
/**
 * 
 * @Class Name :INoUserDao.java
 * @Description : 비회원 공지사항 dao
...
public interface INoUserDao {
	 ...
	 * @throws : Exception
	 */
	public Map<String, Object> getNoticeInfo(Map<String, String> params)throws Exception;
	/**
	 * 
