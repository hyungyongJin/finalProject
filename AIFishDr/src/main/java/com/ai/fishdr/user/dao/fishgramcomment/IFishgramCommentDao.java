...
/**
 * 
 * @Class  Name : IFishgramCommentDao.java
 * @Description : 피쉬그램 댓글 전체관리 Dao 인터페이스
 ...
 * </pre>
 */
public interface IFishgramCommentDao {
	 ...
	 * -----------------------------------
	 * @param  : params (Map<String, String> 타입)
	 * @return : List<Map<String, FishgramCommentVO>>
	 * @throws : Exception
	 */
	 ...
	 * @Method : getCommentMemIdNoDuplicate
	 * @author : 심재형
	 * -----------------------------------
	 * @param  : params (Map<String, String> 타입)
