package com.ai.fishdr.user.service.annymty;
...
import com.ai.fishdr.user.dao.annymty.IAnnymtyboardDao;
...
@Service
public class IAnnymtyboardServiceImpl implements IAnnymtyboardService{
	
//	DAO 연결
	@Autowired
	private IAnnymtyboardDao dao;
