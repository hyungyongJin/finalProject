...
import com.ai.fishdr.user.dao.diseaseboard.IDiseaseboardDao;                                                 
...
@Service                                                                                               
public class IDiseaseboardServiceImpl implements IDiseaseboardService {                                      
	@Autowired                                                                                           
	private IDiseaseboardDao dao;                                                                           
	@Autowired                                                                                           
