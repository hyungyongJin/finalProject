package com.ai.fishdr.user.controller.freeboard;
...
import com.ai.fishdr.user.service.freeboard.IFreeboardService;
...
/**
 * 
 * @Class Name :FreeboardController.java
...
public class FreeboardController {
	...
	public ModelAndView freeboardView(String commentPage, Map<String,String> params,ModelAndView model,String bo_no, String currentPage,
	...
	public void freeboardForm(Model model,Map<String,String>params,String board_code) throws Exception{
	...
	public ModelAndView freeboardList(ModelAndView model , HttpServletRequest request,
			 String bo_no,Map<String,String>params,String search, String keyword,String currentPage, HttpSession session) throws Exception{
		...
		if (writeList.size()==0) {
			params.put("board_code","board002");
			BoardManageVO board_info = boardService.getBoardInfo(params);
			model.addObject("boardName",board_info);
		}
		return model;
	}
	/**
	...
	public ModelAndView insertBoard(ModelAndView model, BoardVO vo, @RequestParam("files") MultipartFile[] files ) throws Exception{
		...
		model.setViewName("redirect:/user/freeboard/freeboardList.do");
		return model;
	}
	/**
	 * 
	...
	public ModelAndView insertComment(String commentPage, String currentPage,String keyword,String search, ModelAndView model, BoardCommentVO vo) throws Exception{
		...
		model.setViewName("redirect:/user/freeboard/freeboardView.do?commentPage="+commentPage+"&bo_no="+vo.getBo_no()+"&currentPage="+currentPage+"&search="+search+"&keyword="+keyword);
		return model;
	...
	public ModelAndView deletebBoard(ModelAndView model, String bo_no, Map<String,String>params) throws Exception{
		...
		if (result) {
			...
			model.setViewName("redirect:/user/freeboard/freeboardList.do?message="+message);
		}else{
			model.setViewName("redirect:/user/freeboard/freeboardList.do");
		}
		return model;
