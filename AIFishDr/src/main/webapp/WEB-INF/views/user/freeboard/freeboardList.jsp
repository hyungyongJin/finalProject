...
$(function(){
	...
	$('#insertBtn').click(function(){
		var code = '';
		if (eval('${writeList[0].BOARD_CODE}'.length >1)) {
			code = '${writeList[0].BOARD_CODE}';
		}else{
			code = 'board002';
		}
		$(location).attr('href','${pageContext.request.contextPath}/user/freeboard/freeboardForm.do?board_code='+code);
	});
			...
			<div class="col-md-12">
				...
				<div class="box" id="boardMgr">
					<div class="box-header">
						<c:if test="${!empty writeList[0].BOARD_NAME}">
							<h3 class="box-title text-green">${writeList[0].BOARD_NAME}</h3>
						</c:if>
						<c:if test="${empty writeList[0].BOARD_NAME}">
							<h3 class="box-title text-green">자유게시판</h3>
						</c:if>
					</div>
					...
					<div class="box-body">
						...
						<div id="example1_wrapper"
							...
							<div class="row">
								<div class="col-sm-12">
									<form action="${pageContext.request.contextPath }/user/freeboard/freeboardList.do" method="post">
										<div class="dropdown">
										...
										<table id="example1"
											...
											<thead>
												...
												<tr style="background-color: lightgrey;" role="row" class="odd">
													...
													<td><a  href="${pageContext.request.contextPath}/user/freeboard/freeboardView.do?bo_no=${list.BO_NO }&currentPage=${currentPage}
