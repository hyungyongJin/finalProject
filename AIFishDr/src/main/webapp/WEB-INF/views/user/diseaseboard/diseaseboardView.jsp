			...
			<div class="box">                                                                        
				...
				<div class="box-body pad">                                                           
					...
					<div class="dropdown">                                                                                                                                                                             
			  			...
			  			|&nbsp; <span style="font-size: 10pt; color: blue;"> 질병게시판</span>                                                                                                        
					...
					<tr>                                                                                                                                                                                               
						<td style="width: 100%;"><div class="input-group input-group-sm" style="width: 80%;" >                                                                                                   
						   ...
						   <button type="button" value="${file.file_no }" style="width:100px; margin-right:10px;"                                                                                                
						   	onclick="javascript:location.href='${pageContext.request.contextPath }/user/diseaseboard/fileDownload.do?file_no=${file.file_no }';" class="downBtn btn btn-info btn-sm">다운로드</button>
		                    </span>                                                                                                                                         
	                	</div></td>                                                                                                                                         
					</tr>                                                                                                                                                   
					</c:if>                                                                                                                                                 
...
<!-- 		  </div> -->                                                                                                                                                    
            ...
            <div class="dataTables_wrapper form-inline dt-bootstrap">                                                                                                   
         	<c:if test="${viewInfo[0].BOARD_FUNCTION eq '0'}">                                                                                                            
                	<form id="insForm" method="post" action="${pageContext.request.contextPath }/user/diseaseboard/insertComment.do?commentPage=${commentPage}&currentPage=${currentPage}&search=${search}&keyword=${keyword}" >
...
$(function(){                                                                                                                                                         
	...
	$('#return').click(function(){                                                                                                                                                    
		$(location).attr('href','${pageContext.request.contextPath}/user/diseaseboard/diseaseboardList.do?currentPage=${currentPage}&search=${search}&keyword=${keyword}');                 
	});                                                                                                                                                                               
	...
	$('#delBtn').click(function(){                                                                                                                                                    
		var bo_no = $(this).val();                                                                                                                                                    
		$(location).attr('href','${pageContext.request.contextPath}/user/diseaseboard/deletediseaseboard.do?bo_no='+bo_no);                                                                 
	});                                                                                                                                                                               
	...
	$('#finalUpdate').click(function(){                                                                                                                                               
		...
		$.ajax({                                                                                                                                                                      
			url: '${pageContext.request.contextPath}/user/diseaseboard/updateBoard.do',                                                                                                  
			processData: false,                                                                                                                                                       
			contentType: false,                                                                                                                                                       
			data: formData,                                                                                                                                                           
			type: 'POST',                                                                                                                                                             
	...
	$('.afCBtn').click(function(){                                                                                                                                                  
		...
		$.ajax({                                                                                                                                                                    
			url: '${pageContext.request.contextPath}/user/diseaseboard/updateComment.do',                                                                                              
	...
	$('#recommend').click(function(){                                                                                            
		...
		$('#yes').click(function(){                                                                                              
			$.ajax({                                                                                                             
				url : '${pageContext.request.contextPath}/user/diseaseboard/boardrecommend.do?bo_no=${viewInfo[0].BO_NO }',         
				type : 'POST',                                                                                                   
				dataType : 'json',                                                                                               
	...
	$('#black').click(function(){                                                                                               
		...
		if ($('input[name=reason]:checked').length== 0) {  
			...
			$.ajax({                                                                                                            
				url : '${pageContext.request.contextPath}/user/diseaseboard/boardblack.do',                                        
				data : data,                                                                                                    
				success : function(result){                                                                                     
					alert("신고가 완료되었습니다.");                                                                          
					$('#black').attr('disabled','disabled').text('이미 신고완료한 게시물입니다.');                              
...
function delComment(comment_no){                                                                                              
	$.ajax({                                                                                                                    
		url : '${pageContext.request.contextPath}/user/diseaseboard/delComment.do?comment_no='+comment_no,                         
		success : function(data){                                                                                               
...
function deleteFile(value){                                                                                                   
	$.ajax({                                                                                                                    
		url : '${pageContext.request.contextPath}/user/diseaseboard/deleteFile.do?file_no='+value,                                 
		success : function(data){                                                                                               
