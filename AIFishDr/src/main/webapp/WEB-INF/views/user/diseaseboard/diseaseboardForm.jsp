...
<section class="content">                                                
	<div class="row">                                                      
		<div class="col-md-12" >                                           
			...
			<form id="insertForm" action="${pageContext.request.contextPath }/user/diseaseboard/insertdiseaseboard.do" method="post" enctype="multipart/form-data"> 
			<div class="form-group" style="margin-left: 60px;">                                                                                               
			<div class="box">                                                                                                                                   
			<hr>                                                                                                                                                  
				<label style="float:left; margin: 5px 5px 5px 10px; color: green;">게시판 :</label>                                                             
				<label style="float:left; margin: 5px 5px 5px 10px;">질병게시판</label>                                                            
				<br>                                                                                                                                              
				<br>                                                                                                                                              
				<br>                                                                                                                                              
...
$(function(){                                                                                                                                                    
   ...
   $('#return').click(function(){                                                                          
	  $(location).attr('href','${pageContext.request.contextPath}/user/diseaseboard/diseaseboardList.do') ;        
   });                                                                                                     
