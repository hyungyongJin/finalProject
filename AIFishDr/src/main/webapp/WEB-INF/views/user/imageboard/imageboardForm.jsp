	...
	<div class="content-wrapper" style="margin-left: 10px;">
		...
		<section class="content">
			<div class="row">
				<div class="col-md-12">
					<form id="insertForm"
						action="${pageContext.request.contextPath }/user/imageboard/insertImageForm.do"
						method="post" enctype="multipart/form-data">
						<div class="form-group" style="margin-left: 60px;">
							<div class="box">
								<hr>
								<label style="float: left; margin: 5px 5px 5px 10px; color: green;">
									게시판 :
								</label> 
								<label style="float: left; margin: 5px 5px 5px 10px;">
								...
								<input type="hidden" class="form-control" name="bo_writer"
								...
								<button type="button" id="return"
									...
									class="btn btn-info btn-flat bg-purple pull-right">
									목록
								</button>
...
// 		}
		...
		else if ($('textarea[name=bo_content]').val() == '') {
			alert('내용을 입력해 주세요');
			return;
			}
		else if(ss == ''){
