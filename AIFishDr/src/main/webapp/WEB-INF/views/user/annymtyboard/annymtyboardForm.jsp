...
<section class="content">
	<div class="row">
		<div class="col-md-12" >
			...
			<form id="insertForm" action="${pageContext.request.contextPath }/user/annymtyboard/insertannymtyboard.do" method="post" enctype="multipart/form-data">
...
// 		$(this).parent('td').parent('tr').remove();
   ...
   $('#return').click(function(){
	  $(location).attr('href','${pageContext.request.contextPath}/user/annymtyboard/annymtyboardList.do') ;
   }); 
