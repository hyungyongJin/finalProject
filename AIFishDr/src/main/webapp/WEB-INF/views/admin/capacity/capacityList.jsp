	...
	<div class="content-wrapper" style="margin-left: 10px;">
		...
		<section class="content">
			<div class="row">
				<div class="col-md-12">
					<form
						action="${pageContext.request.contextPath }/admin/capacity/capacityList.do"
						method="post">
					...
					<div class="box" style="width: 100%;">
						...
						<div class="box-body">
							<div id="example1_wrapper"
								...
								<form
									action="${pageContext.request.contextPath }/admin/capacity/capacityDelete.do"
												...
												<thead>
													<tr role="row">
														...
														<th class="sorting" tabindex="0" aria-controls="example1"
															...
															style="width: 20%; text-align: center;">어종명</th>
														<th class="sorting" tabindex="0" aria-controls="example1"
															rowspan="1" colspan="1"
															aria-label="Engine version: activate to sort column ascending"
															style="width: 25%; text-align: center;">의약품명</th>
														<th class="sorting" tabindex="0" aria-controls="example1"
															rowspan="1" colspan="1"
															aria-label="Engine version: activate to sort column ascending"
															style="width: 35%; text-align: center;">용법 및 용량</th>
														<th class="sorting" tabindex="0" aria-controls="example1"
															rowspan="1" colspan="1"
															aria-label="CSS grade: activate to sort column ascending"
															style="width: 15%; text-align: center;">상세</th>
													</tr>
												</thead>
												<tbody>
													<c:forEach items="${CapacityList}" var="list">
														<tr role="row" class="odd">
															<td><input 
																value="${list.uscp_code}" type="checkbox"
																class="checkboxes" name="uscp_code"> <input
																value="${list.uscp_code}" type="hidden"></td>
<%-- 															<td>${list.rnum }</td> --%>

															<td>${list.fish_name }</td>
															<td>${list.mdcin_prduct_name }</td>
															<td>${list.uscp_content }</td>

															<td>
																<button value="${list.uscp_code}" type="button"
																	class="viewBtn btn btn-primary btn-sm" data-toggle="modal"
								...
								<div class="row">
									...
									<div class="col-sm-7">${CapacityPaging }</div>
								</div>
							</div>
							<button type="button" style="width: 140px; margin-right: 20px;"
								class="btn btn-info btn-sm pull-right" data-toggle="modal"
								data-target="#myModal2">등록</button>
							<button id="deleteBtn" name="deleteName" type="button"
								style="width: 140px; margin-right: 20px;"
								class="btn btn-info btn-sm pull-right">삭제</button>
			...
			<div class="modal-dialog">
				...
				<div class="modal-content" style="width: 100%;">
					<div class="modal-header">
						...
						<h3 class="modal-title" style="text-align: center;">용법 및 용량
							상세화면</h3>
					</div>
					<div class="modal-body">

						<form name="updateForm"
							action="${pageContext.request.contextPath }/admin/capacity/capacityUpdate.do"
							method="post">
							<input id="uscp_code" type="hidden" value="" name="uscp_code">
							<div class="box box-info" style="height: 380px;">
								...
								<label style="float: left; margin-left: 55px;">용법 및 용량 :</label>
								<textarea id="updateText" name="uscp_content" 
									style="width: 53%; margin-left: 20px; margin-bottom: 10px; float: left; height: 30%;"></textarea>
							</div>
				...
				<div class="modal-content" style="width: 100%;">
					...
					<div class="modal-body">
						...
						<form name="insertForm"
							action="${pageContext.request.contextPath }/admin/capacity/capacityInsert.do"
							method="post">
							<input id="uscp_code" type="hidden" value="" name="uscp_code">
							<div class="box box-info" style="height: 380px;">
								<br> <br> <br>
								...
								<label style="float: left; margin-left: 55px;">용법 및 용량 :</label>
								<textarea id="insertText" name="uscp_content"
									style="width: 53%; margin-left: 20px; margin-bottom: 10px; float: left; height: 30%;"></textarea>
							</div>
...
$(function(){
	...
	$('.viewBtn').click(function(){
		...
		var uscp_code = $(this).val();
		$('#fish_name').text('');
		$('#mdcin_name').text('');
		$('textarea[name=uscp_content]').val('');
// 		var fish_name = $('#fishNameSelect').val();
// 		var mdcin_prduct_name =  $('#proSelect').val();
		$('#uscp_code').val(uscp_code);
		
		$.ajax({
			url : '${pageContext.request.contextPath}/admin/capacity/capacityInfo.do?uscp_code='+uscp_code,
			success : function(data){
				...
				$('#updateText').val(data.info.uscp_content);
			},
			error : function(res){
				alert(res.status);
			}
	...
	$('#insertBtn').click(function(){
		...
		if ($('#fishNameSelect2').val() != '선택하세요' && $('#proSelect2').val() != '선택하세요'
			...
			alert("등록할 할 데이터를 모두 선택및 입력해 주세요.");
		}
	});
	...
	$('button[name=deleteName]').click(function(){
		...
		if(checkRow == ''){
			...
			$(location).attr('href','${pageContext.request.contextPath }/admin/capacity/capacityDelete.do?uscp_code='+checkRow);
		}
